...
const locoScroll = new LocomotiveScroll({
  ...
  smooth: true,
  lerp: 0.08,  // lower = smoother scroll (default ~0.1)
...
tl3.from("#page5 .left5 h1", {
    x: -200,
    opacity: 0,
    duration: 2
});

tl3.from("#page5 .right5 h3", {
    x: 200,
    opacity: 0,
    duration: 2
}, "-=1");

tl3.from("#page5 .right5 button", {
    y: 50,
    opacity: 0,
    duration: 1
}, "-=0.5");
...
gsap.from("#page6 h3", {
    scrollTrigger: {
        trigger: "#page6",
        start: "top 80%",     // start when top of page6 reaches 80% viewport
        scroller: "#main"
    },
    y: -50,
    opacity: 0,
